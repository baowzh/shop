...
if (! class_exists ( '\Eccube\Entity\Product' )) {
	...
	class Product extends \Eccube\Entity\AbstractEntity {
		...
		/**
		 *
		 * @var integer @ORM\Column(name="id", type="integer", options={"unsigned":true})
		 *      @ORM\Id
		...
		/**
		 *
		 * @var string|null @ORM\Column(name="description_list", type="string", length=4000, nullable=true)
		 */
		private $description_list;
		
		/**
		 *
		 * @var string|null @ORM\Column(name="description_detail", type="string", length=4000, nullable=true)
		 */
		private $description_detail;
		
		/**
		 *
		 * @var string|null @ORM\Column(name="search_word", type="string", length=4000, nullable=true)
		 */
		private $search_word;
		
		/**
		 *
		 * @var string|null @ORM\Column(name="free_area", type="text", nullable=true)
		 */
		private $free_area;
		
		/**
		 *
		 * @var \DateTime @ORM\Column(name="create_date", type="datetimetz")
		 */
		private $create_date;
		
		/**
		 *
		 * @var \DateTime @ORM\Column(name="update_date", type="datetimetz")
		 */
		private $update_date;
		
		/**
		 *
		 * @var \Doctrine\Common\Collections\Collection @ORM\OneToMany(targetEntity="Eccube\Entity\ProductCategory", mappedBy="Product", cascade={"persist","remove"})
		 */
		private $ProductCategories;
		
		/**
		 *
		 * @var \Doctrine\Common\Collections\Collection @ORM\OneToMany(targetEntity="Eccube\Entity\ProductClass", mappedBy="Product", cascade={"persist","remove"})
		 */
		private $ProductClasses;
		
		/**
		 *
		 * @var \Doctrine\Common\Collections\Collection @ORM\OneToMany(targetEntity="Eccube\Entity\ProductImage", mappedBy="Product", cascade={"remove"})
		 *      @ORM\OrderBy({
		 *      "sort_no"="ASC"
		 *      })
		 */
		...
		/**
		 *
		 * @var \Doctrine\Common\Collections\Collection @ORM\OneToMany(targetEntity="Eccube\Entity\ProductTag", mappedBy="Product")
		 */
		private $ProductTag;
		
		/**
		 *
		 * @var \Doctrine\Common\Collections\Collection @ORM\OneToMany(targetEntity="Eccube\Entity\CustomerFavoriteProduct", mappedBy="Product")
		 */
		private $CustomerFavoriteProducts;
		
		/**
		 *
		 * @var \Eccube\Entity\Member @ORM\ManyToOne(targetEntity="Eccube\Entity\Member")
		 *      @ORM\JoinColumns({
		...
		/**
		 *
		 * @var \Eccube\Entity\Master\ProductStatus @ORM\ManyToOne(targetEntity="Eccube\Entity\Master\ProductStatus")
		 *      @ORM\JoinColumns({
		...
		/**
		 *
		 * @var string|null @ORM\Column(name="title", type="string",length=4000 ,nullable=true)
		 */
		private $title;
		/**
		 *
		 * @var string|null @ORM\Column(name="description", type="string",length=255, nullable=true)
		 */
		private $description;
		/**
		 *
		 * @var string|null @ORM\Column(name="keyword", type="string",length=1000, nullable=true)
		 */
		private $keyword;
